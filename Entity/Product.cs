...
namespace Entity
{
    ...
    {
        public Product(int id, string productName, double productPurchasePrice, double productSalesPrice, int productFirstStockQuantity, int productLastStockQuantity) : base(id)
        {
